...
<html lang="id">
  <head>
    ...
    @include('partials.topscript')
    <title>GCars | {{ $title }}</title>
  </head>
  <body>
    <div class="super_container">
      ...
      {{-- Main Content --}}
      <div class="container" style="min-height: 572px">
        @yield('content')
      </div>
      {{-- End Main Content --}}
      ...
      <div class="footer">
          ...
          <div>
            ...
            <ul>
                <li>
                  ...
                  <span>Jalan Bandung Sebelah Kanan.</span>
                </li>
                <li>
        ...
        <div>
          <h4>Copyright &copy; 2022 <a href="/">GCars</a>. All rights reserved.</h4>
        </div>
      </div>
    </div>
