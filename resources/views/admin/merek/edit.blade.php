      ...
      <div class="card-body">
        <form action="{{ route('merek.update', $merek->id) }}" method="post">
          ...
          <div class="mb-3">
            ...
            <input type="text" name="nama" id="nama" class="form-control  @error('nama') is-invalid @enderror" autocomplete="off" value="{{ $merek->nama }}">
            @error('nama')
          ...
          <div class="mb-3">
            ...
            <input type="text" id="slug" disabled class="form-control" value="{{ $merek->slug }}">
          </div>
